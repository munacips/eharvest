...
public class LogisticsProviderController {
    ...
    @PostMapping
    public ResponseEntity<UserResponseDTO> createLogisticsProvider(LogisticsProviderDto dto){
    ...
    @PutMapping("{id}")
    public ResponseEntity<UserResponseDTO> updateLogisticsProvider(@PathVariable Long id, @RequestBody LogisticsProviderDto dto){
